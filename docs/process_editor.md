...
From the **Start Processes** row, you can choose which processes you want to run when the state is active. This is useful for chaining commands like having a process that starts a pump when the state is started.

From the **Stop Processes** row, you can choose which processes you want to stop when the state is active.

From the Assert Registers row, you can utilize any ladder logic registers that you have configured on the [Ladder Logic](ladder_logic.md) page.
